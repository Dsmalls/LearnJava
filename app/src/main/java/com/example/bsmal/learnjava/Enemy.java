...
public class Enemy {  // superclass...part of the inheritance examples
    private String name;
    ...
    public void takeDamage(int damage){
        ...
        if(remainingHitPoints > 0){
            ...
            if(lives > 0){
                System.out.println("I lost a life, " + this.lives + " lives left");
            } else {
                System.out.println("No lives left, Im DEAD! ");
            }
        }
    }
